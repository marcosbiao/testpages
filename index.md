...
A arquitetura do projeto foi estruturada para maximizar a clareza e a rastreabilidade do processo de aprendizado, com cada lista de exercícios ou tópico sendo alocado em um diretório dedicado. A abordagem científica na resolução das tarefas segue o rigor esperado, onde cada solução é acompanhada por uma breve explanação técnica que justifica a construção do autômato ou a derivação da linguagem formal proposta. Acreditamos que a capacidade de formalizar um problema e, em seguida, construir um modelo computacional que o resolva (ou prove que não pode ser resolvido) é uma habilidade central na Ciência da Computação. Dessa forma, este repositório se estabelece como um registro artefatorial da aplicação prática das teorias de LFA, fornecendo uma base robusta para o aprofundamento em tópicos avançados de Teoria da Computação e Compiladores.
